...
class Visualizer():
    def __init__(self):
        self.classID_dict = {0: ("Escooter", (0, 90, 255)), 1: ("Pedestrians", (255, 90, 0)), 2: ("Cyclists", (90, 255, 0))}
    ...
    def drawBBOX(self, xyxy, frame):
        for detection in xyxy:
            ...
            frame = cv2.rectangle(frame, (x1, y1 - 20), (x1 + w1, y1), color, -1)
            frame = cv2.putText(
                frame, textLabel, (x1, y1 - 5), 
                cv2.FONT_HERSHEY_SIMPLEX, 0.6, self.textColor, 1
            )
