    ...
    for json_file in sorted(Path(json_dir).resolve().glob('*.json')):
        ...
        for x in tqdm(data['annotations'], desc=f'Annotations {json_file}'):
            ...
            if box[2] > 0 and box[3] > 0:  # if w > 0 and h > 0
                ...
                with open(r'C:\Users\balaji\Desktop\Yolo\YoloV5\yolov5\COCO2YOLO\new_dir\labels\valid.txt', 'a') as file:
...
if __name__ == '__main__':
    ...
    if source == 'COCO':
        convert_coco_json(r'C:\Users\balaji\Desktop\Yolo\YoloV5\yolov5\COCO2YOLO\Test_JSONS')  # directory with *.json
